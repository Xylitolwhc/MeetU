...
public class EditUmbrellaActivity extends Activity {
    ...
    private ImageView imageView, addboy, addgirl, addsecret, clock, titleImg, back;
    private LinearLayout backgroung;
    private String selectedTime;
    private LocationInfor locationInfor;
    private Button button, cancelButton, meetButton;
    private LinearLayout helperLayout, buttonLayout;
    private int sex = 0, mode = 0;
    ;
    private static final String TAG = "EditUmbrellaActivity";
